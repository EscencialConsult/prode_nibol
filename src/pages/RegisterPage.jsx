...
export default function RegisterPage() {
  const [form, setForm]       = useState({ nombre: '', ci: '', password: '' })
  ...
  async function handleSubmit(e) {
    ...
    setError(null)
    try {
      // Se registra con CI; sheetsApi arma el email ficticio.
      await sheetsApi.auth.registro(form.nombre, form.ci, form.password)
      setDone(true)
    } catch (err) {
            ...
            {done ? (
              ...
              <div className="text-center py-4">
                ...
                <p className="font-body text-sm leading-relaxed mb-8 max-w-xs mx-auto" style={{ color: 'rgba(255,255,255,.4)' }}>
                  Cuando el administrador la apruebe, vas a poder ingresar con tu <strong style={{ color: '#ebc32b' }}>CI</strong> y la contraseña que elegiste.
                </p>
