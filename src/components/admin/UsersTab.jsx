...
// El identificador visible es el CI. Si la fila no lo trae (ej: registro
// espontáneo sin CI cargado), lo derivamos del email ficticio {ci}@nibol.local.
function getCI(u = {}) {
  return u.ci || String(u.email || '').replace(/@nibol\.local$/i, '')
}
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex items-center gap-3 min-w-0 flex-1">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs font-body truncate" style={{ color: '#5f6e8a' }}>CI: {getCI(u)}</p>
